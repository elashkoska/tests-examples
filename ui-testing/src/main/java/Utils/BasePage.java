...
//    }
    ...
    protected void waitForElementoToBeClickableAndClick(WebElement element) {
        moveToElement(element);
        wait.until(ExpectedConditions.elementToBeClickable(element));
        element.click();
    }

    protected WebElement waitAndFindElementFromRoot(By locator) {
        wait.until(ExpectedConditions.presenceOfElementLocated(locator));
        return driver.findElement(locator);
    }

//    protected List<WebElement> waitAndFindElements(WebElement root, By locator) {
